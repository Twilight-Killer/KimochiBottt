...
PM_START_TEXT = """ 
*ʜᴇʏ* {}, *ɪ'ᴍ {} ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘs!
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="📚 ʙᴀɴᴛᴜᴀɴ ᴅᴀɴ ᴘᴇʀɪɴᴛᴀʜ", callback_data="Main_help"),
    ],
...
HELP_STRINGS = f"""
» *{BOT_NAME}. ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ ᴅɪ ʙᴀᴡᴀʜ ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀᴘᴀᴛᴋᴀɴ ᴘᴇɴᴊᴇʟᴀꜱᴀɴ ᴛᴇɴᴛᴀɴɢ ᴘᴇʀɪɴᴛᴀʜ ꜱᴘᴇꜱɪꜰɪᴋ*"""

DONATE_STRING = f"""ʜᴇʏ ʙᴀʙʏ.
ꜱᴇɴᴀɴɢ ᴍᴇɴᴅᴇɴɢᴀʀ ʙᴀʜᴡᴀ ᴀɴᴅᴀ ɪɴɢɪɴ ʙᴇʀᴅᴏɴᴀꜱɪ.
ᴀɴᴅᴀ ᴅᴀᴘᴀᴛ ʟᴀɴɢꜱᴜɴɢ ᴍᴇɴɢʜᴜʙᴜɴɢɪ ᴘᴇɴɢᴇᴍʙᴀɴɢ ꜱᴀʏᴀ"""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgUAAx0CWvaI6gACVWhlQgPDOymiNeL8klx8Wbl0JGhQoAACug8AAuAMEVZXwXNgAAHdhKYzBA")
            x.delete()
        ...
        update.effective_message.reply_photo(
            START_IMG,
            caption="ɪ ᴀᴍ ᴀʟɪᴠᴇ!\n<b>ɪ ᴅɪᴅɴ'ᴛ ꜱʟᴇᴇᴘ sɪɴᴄᴇ​:</b> <code>{}</code>".format(
                uptime
            ),
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        query.message.edit_caption(f"*ᴛʜɪs ɪs {dispatcher.bot.first_name}*"
            "\n*ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇᴀꜱɪʟʏ ᴀɴᴅ ᴛᴏ ᴘʀᴏᴛᴇᴄᴛ ʏᴏᴜʀ ɢʀᴏᴜᴘ ꜰʀᴏᴍ ꜱᴄᴀᴍᴍᴇʀꜱ ᴀɴᴅ ꜱᴘᴀᴍᴍᴇʀꜱ.*"
            "\n*ᴡʀɪᴛᴛᴇɴ ɪɴ ᴩʏᴛʜᴏɴ ᴡɪᴛʜ sǫʟᴀʟᴄʜᴇᴍʏ ᴀɴᴅ ᴍᴏɴɢᴏᴅʙ ᴀs ᴅᴀᴛᴀʙᴀsᴇ.*"
            "\n\n────────────────────"
            f"\n*➻ ᴜᴩᴛɪᴍᴇ »* {uptime}"
            f"\n*➻ ᴘᴇɴɢɢᴜɴᴀ »* {sql.num_users()}"
            f"\n*➻ ᴏʙʀᴏʟᴀɴ »* {sql.num_chats()}"
            "\n────────────────────"
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴘᴇʀɪɴᴛᴀʜ 💁", callback_data="Main_help"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
        ...
        query.message.edit_caption("**ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ ᴅɪ ʙᴀᴡᴀʜ ɪɴɪ ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀᴘᴀᴛᴋᴀɴ ʙᴀɴᴛᴜᴀɴ ᴅᴀɴ ɪɴꜰᴏʀᴍᴀꜱɪ ʟᴇʙɪʜ ʟᴀɴᴊᴜᴛ**"
            f"\n\nᴊɪᴋᴀ ᴀɴᴅᴀ ᴍᴇɴᴇᴍᴜᴋᴀɴ ʙᴜɢ ᴅɪ {dispatcher.bot.first_name} ᴀᴛᴀᴜ ᴊɪᴋᴀ ᴀɴᴅᴀ ɪɴɢɪɴ ᴍᴇᴍʙᴇʀɪᴋᴀɴ ᴛᴀɴɢɢᴀᴘᴀɴ ᴛᴇɴᴛᴀɴɢ {dispatcher.bot.first_name}, ꜱɪʟᴀᴋᴀɴ ʟᴀᴘᴏʀᴋᴀɴ ᴅɪ ᴄʜᴀᴛ ᴅᴜᴋᴜɴɢᴀɴ.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/haotogel_result"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ɢʀᴏᴜᴘ 🍹", url="https://t.me/HaoTogelLivedraw"
                        ),
                    ],
                    [
...
def MukeshRobot_Main_Callback(update: Update, context: CallbackContext):
 ...
 ɪɴɪ ᴀᴅᴀʟᴀʜ ᴍᴇɴᴜ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ {BOT_NAME}
""",
            parse_mode=ParseMode.MARKDOWN,
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• ᴅᴏɴᴀꜱɪ •", url="https://t.me/DarkiezZzz"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="mukesh_support")
                    ]
                ]
            ),
            )  
...
*ʜᴇʀᴇ ɪs ᴍʏ :* [sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ](https://t.me/DarkiezZzz)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://t.me/DarkiezZzz).
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="https://t.me/DarkiezZzz")
                ],
                 [
        InlineKeyboardButton(text="🏡", callback_data="mukesh_back"),
        InlineKeyboardButton(text="🛡️", callback_data="mukesh_"),
...
def Music_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "Music_":
        query.message.edit_caption(f"""
 ɪɴɪ ᴀᴅᴀʟᴀʜ ᴍᴇɴᴜ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴍᴜꜱɪᴄ 
""",
            parse_mode=ParseMode.MARKDOWN,
...
""",
        ...
        query.message.edit_caption(f"*» ᴘᴇʀɪɴᴛᴀʜ ᴇxᴛʀᴀ «*"
            f"""
